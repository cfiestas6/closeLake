...
export class CloseLake__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class CloseLake extends ethereum.SmartContract {
  static bind(address: Address): CloseLake {
    return new CloseLake("CloseLake", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): CloseLake__getListingResultValue0Struct {
    ...
    return changetype<CloseLake__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<CloseLake__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<CloseLake__getListingResultValue0Struct>(value[0].toTuple())
    );
  }
